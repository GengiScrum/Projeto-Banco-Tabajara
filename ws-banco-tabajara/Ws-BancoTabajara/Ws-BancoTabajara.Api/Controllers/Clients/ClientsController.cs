...
namespace Ws_BancoTabajara.Api.Controllers.Clients
{
    ...
    public class ClientsController : ApiControllerBase
    {
        ...
        {
            ClientQuery query = new ClientQuery() { Quantity = Request.GetQueryQuantityValueExtension() };
            return HandleQueryable<Client, ClientViewModel>(_clientService.GetAll(query));
        }
